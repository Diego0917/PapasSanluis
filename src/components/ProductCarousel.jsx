...
export function ProductCarousel() {
  const products = [
    ...
    { name: "Panes Especiales", img: "https://images.unsplash.com/photo-1509440159596-0249088772ff?q=80&w=500" },
    { name: "Aceites Vegetales", img: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?q=80&w=500" },
    { name: "Cortes de Carne", img: "https://images.unsplash.com/photo-1607623814075-e512199b4282?q=80&w=500" },
  ];
    ...
    <section className="py-20 bg-white">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 flex flex-col items-center">
          ...
          />
          <h2 className="text-4xl font-bold text-[#003DA5] mb-2">Nuestro Portafolio</h2>
          <p className="text-gray-600 italic">Calidad garantizada del campo a tu negocio</p>
        </div>
